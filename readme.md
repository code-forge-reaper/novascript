...
───────────────────────────────────────────────────────────────────────────────
Python                  5       6,002       451       171      5,380        804
───────────────────────────────────────────────────────────────────────────────
novascript.py                   4,006       333       158      3,515        759
parsel.py                       1,279         0         2      1,277          2
nodes.py                          687       109         9        569         38
nova.py                            30         9         2         19          5
───────────────────────────────────────────────────────────────────────────────
Total                   5       6,002       451       171      5,380        804
───────────────────────────────────────────────────────────────────────────────
