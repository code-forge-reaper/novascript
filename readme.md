...
───────────────────────────────────────────────────────────────────────────────
Python                  4       6,603       679       226      5,698      1,122
───────────────────────────────────────────────────────────────────────────────
novascript.py                   4,233       441       213      3,579      1,016
parsel.py                       1,281         0         2      1,279          2
nodes.py                        1,060       231         9        820         99
nova.py                            29         7         2         20          5
───────────────────────────────────────────────────────────────────────────────
Total                   4       6,603       679       226      5,698      1,122
───────────────────────────────────────────────────────────────────────────────
